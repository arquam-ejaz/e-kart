...
function Payment() {
  ...
  const handleCryptoPayment = async (e) =>{
    e.preventDefault();
    await window.account.sendMoney("e-kart.testnet", new BN("1000000000000000000000000"));
    //await window.contract.transfer({}, null, 1000000000000000000000000).then(()=>{console.log("COMPLETED")})
  }
